...
! function (t) {
    ...
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function (n) {
       ...
       e.fn.dataTable || require("datatables.net")(n, e), e.fn.dataTable.Buttons || require("datatables.net-buttons")(n, e)
    ...
    return n.extend(o.ext.buttons, {
       ...
       columnVisibility: {
          ...
          init: function (o, n, i) {
             var l = this;
             n.attr("data-cv-idx", i.columns), o.on("column-visibility.dt" + i.namespace, function (n, e) {
