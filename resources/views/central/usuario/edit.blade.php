...
@section('content')
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        @component('components.titulo-pagina', ['nome' => "Edição de Usuário"])
        @endcomponent
        ...
        <input type="text" name="pageType" value="edit" id="pageType" hidden>
        <div class="card mt-5">
            <div class="card-body">
                ...
                <form action="{{ route(request()->getHost().'.usuarios.atualizar', ['id' => $usuario->id]) }}" method="POST">
                    @csrf
                        ...
                        <div class="tab-pane" id="usuarioInfo">
                            <div class="mt-5 grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="rgUsuarioInput" name="rgUsuarioInput" value="{{ $usuario->rg }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                ...
                                <div class="mb-4 text-center">
                                    ...
                                    <div class="row mt-2">
                                        <div class="relative inline-block w-10 align-middle transition duration-200 ease-in ltr:mr-2 rtl:ml-2">
                                            <input type="checkbox" name="statusUsuarioInput" id="statusUsuarioInput" @if($usuario->status) checked @endif class="absolute block size-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-custom-500 dark:checked:border-custom-500 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-custom-500 dark:checked:after:text-custom-500 checked:after:content-['\eb7b']">
                                        ...
                                        <label for="statusUsuarioInput" id="switchLabel" class="inline-block text-base font-medium cursor-pointer">{{ $usuario->status ? 'Ativo' : 'Inativo' }}</label>
                                    </div>
                            ...
                            <div class="mt-8 grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-3">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="email" id="emailUsuarioInput" name="emailUsuarioInput" value="{{ $usuario->email }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="telefoneUsuarioInput" name="telefoneUsuarioInput" value="{{ $usuario->telefone }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                            ...
                            <div class="mt-8 grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-3">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="cargoUsuarioInput" name="cargoUsuarioInput" value="{{ $usuario->cargo }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                            ...
                            <div class="mt-5 grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-12">
                                <div class="mb-4 md:col-span-2">
                                    ...
                                    <input type="date" id="dataAdmissaoUsuarioInput" name="dataAdmissaoUsuarioInput" value="{{ $usuario->admissao }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                ...
                                <div class="mb-4 md:col-span-2">
                                    ...
                                    <input type="date" id="dataDemissaoUsuarioInput" name="dataDemissaoUsuarioInput" value="{{ $usuario->demissao }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                ...
                                <div class="mb-4 md:col-span-3">
                                    ...
                                    <div class="flex flex-wrap">
                                        <div class="inline-flex text-center input-step w-full">
                                            ...
                                            <input type="number" name="descontoUsuarioInput" id="descontoUsuarioInput" value="{{ $usuario->desconto }}" class="w-full text-center ltr:pl-2 rtl:pr-2 h-10 border-y border-x product-quantity border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" step="0.1">
                                ...
                                <div class="mb-4 md:col-span-2">
                                    ...
                                    <select name="comissaoUsuarioInput" id="comissaoUsuarioInput" class="form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                        <option value="null" {{ $usuario->comissao === 'null' ? 'selected' : '' }}>Nenhum</option>
                                        <option value="desconto" {{ $usuario->comissao === 'desconto' ? 'selected' : '' }}>Desconto</option>
                                        <option value="margem" {{ $usuario->comissao === 'margem' ? 'selected' : '' }}>Margem</option>
                                    </select>
                                ...
                                <div class="mb-4 md:col-span-3">
                                    ...
                                    <input type="text" id="metasuarioInput" name="metasuarioInput" value="{{ number_format($usuario->meta,2,",",".") }}" onKeyPress="return(moeda(this,'.',',',event))" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                            ...
                            @component('components.endereco', [
                                'cep' => $usuario->endereco->cep ?? null,
                                'endereco' => $usuario->endereco->logradouro ?? null,
                                'bairro' => $usuario->endereco->bairro ?? null,
                                'cidade' => $usuario->endereco->cidade->nome ?? null,
                                'numero' => $usuario->end_num ?? null,
                                'complemento' => $usuario->complemento ?? null,
                                'sigla_estado' => $usuario->endereco->cidade->estado->sigla ?? null,
                                'prefix' => null
                            ])
                            @endcomponent
                            <div class="mb-4">
                                <label for="obsUsuarioInput" class="inline-block mb-2 text-base font-medium">Observação</label>
                                <textarea name="obsUsuarioInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" id="obsUsuarioInput" rows="3">{{ $usuario->obs }}</textarea>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="mt-5 grid grid-cols-1 gap-5 xl:grid-cols-2">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="relative">
                                                <input type="password" id="senhaFarmaPopular" name="senhaFarmaPopular" value="{{ $usuario->farmaciaPopular->senha ?? "" }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                            ...
                                            <div class="mb-4 md:col-span-2">
                                                ...
                                                <select name="acessoUsuarioInput" id="acessoUsuarioInput" class="form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                                    ...
                                                    @foreach($acessos as $acesso)
                                                        <option value="{{ $acesso->id }}" {{ old('acessoUsuarioInput') ? (old('acessoUsuarioInput', $acesso->id, $usuario->acessos->pluck('id')->toArray()) == $acesso->id ? 'selected' : '') : (in_array($acesso->id, $usuario->acessos->pluck('id')->toArray()) ? 'selected' : '') }}>
                                                            {{ $acesso->nome }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                        ...
                                                        <div class="flex items-center mb-4">
                                                            <div class="relative inline-block w-10 align-middle transition duration-200 ease-in ltr:mr-2 rtl:ml-2">
                                                                <input type="checkbox" value="{{ $permissao->id }}" name="permissoesUsuario[]" id="{{ "permussaoEspecial_" . $permissao->id }}" class="absolute block size-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-custom-500 dark:checked:border-custom-500 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-custom-500 dark:checked:after:text-custom-500 checked:after:content-['\eb7b']"
                                                                    @if(in_array($permissao->id,  old('permissoesUsuario') ? old('permissoesUsuario', []) : $usuario->permissoesEspeciais->pluck('id')->toArray()))
                                                                        checked
                                                                    @endif
                                                                >
