...
@section('content')
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        @component('components.titulo-pagina', ['nome' => "Edição de Loja"])
        @endcomponent
        ...
        <div class="card mt-5">
            <div class="card-body">
                ...
                <div class="mt-5 tab-content">
                    <form action="{{ route(request()->getHost().'.lojas.atualizar', ['id' => $loja->id, 'representanteLojaId' => $representanteLoja->id]) }}" method="POST">
                        @csrf
                        <div class="block tab-pane" data-tab-id="1" id="lojaInfo">
                            <div class="mt-8 grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-3">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="razaoSocialLojaInput" name="razaoSocialLojaInput" value="{{ $loja->razao_social }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="fantasiaLojaInput" name="fantasiaLojaInput" value="{{ $loja->fantasia }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                            ...
                            <div class="mt-5 grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-12">
                                <div class="mb-4 md:col-span-4">
                                    ...
                                    <input type="text" id="proprietarioLojaInput" name="proprietarioLojaInput" value="{{ $loja->proprietario }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                ...
                                <div class="mb-4 md:col-span-4">
                                    ...
                                    <input type="text" id="gerenteLojaInput" name="gerenteLojaInput" value="{{ $loja->gerente }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                ...
                                <div class="mb-4 text-center md:col-span-2">
                                    ...
                                    <div class="row mt-2">
                                        <div class="relative inline-block w-10 align-middle transition duration-200 ease-in ltr:mr-2 rtl:ml-2">
                                            <input type="checkbox" name="statusLojaInput" id="statusLojaInput" @if($loja->status) checked @endif class="absolute block size-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-custom-500 dark:checked:border-custom-500 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-custom-500 dark:checked:after:text-custom-500 checked:after:content-['\eb7b']">
                                        ...
                                        <label for="statusLojaInput" id="switchLabel" class="inline-block text-base font-medium cursor-pointer">{{ $loja->status ? 'Ativa' : 'Inativa' }}</label>
                                    </div>
                                ...
                                <div class="mb-4 text-center md:col-span-2">
                                    ...
                                    <div class="row mt-2">
                                        <div class="relative inline-block w-10 align-middle transition duration-200 ease-in ltr:mr-2 rtl:ml-2">
                                            <input type="checkbox" name="lojaIntegradaSwitch" id="lojaIntegradaSwitch" @if($loja->integrada) checked @endif class="absolute block size-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-custom-500 dark:checked:border-custom-500 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-custom-500 dark:checked:after:text-custom-500 checked:after:content-['\eb7b']">
                                        ...
                                        <label for="lojaIntegradaSwitch" id="switchLabel1" class="inline-block text-base font-medium cursor-pointer">{{ $loja->integrada ? 'Sim' : 'Não' }}</label>
                                    </div>
                            ...
                            <div class="mt-5 grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-12">
                                ...
                                @if (!$matrizExists)
                                    <div class="mb-4 text-center md:col-span-2">
                                        ...
                                        <div class="mt-2">
                                            <div class="relative inline-block w-10 align-middle transition duration-200 ease-in ltr:mr-2 rtl:ml-2">
                                                <input type="checkbox" name="abastecerPrecoLojaInput" id="abastecerPrecoLojaInput" @if($loja->abastecer_preco) checked @endif class="absolute block size-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-custom-500 dark:checked:border-custom-500 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-custom-500 dark:checked:after:text-custom-500 checked:after:content-['\eb7b']">
                                    ...
                                    <div class="mb-4 text-center md:col-span-2">
                                        ...
                                        <div class="row mt-2">
                                            <div class="relative inline-block w-10 align-middle transition duration-200 ease-in ltr:mr-2 rtl:ml-2">
                                                <input type="checkbox" name="lojaMatrizSwitch" id="lojaMatrizSwitch" @if($loja->matriz) checked @endif class="absolute block size-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-custom-500 dark:checked:border-custom-500 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-custom-500 dark:checked:after:text-custom-500 checked:after:content-['\eb7b']">
                            ...
                            @component('components.endereco', [
                                    ...
                                    'endereco' => $loja->endereco->logradouro ?? null,
                                    'bairro' => $loja->endereco->bairro ?? null,
                                    'cidade' => $loja->endereco->cidade->nome ?? null,
                                    'numero' => $loja->end_num ?? null,
                                    'complemento' => $loja->complemento ?? null,
                                    'sigla_estado' => $loja->endereco->cidade->estado->sigla ?? null,
                                    'prefix' => null
                                ])
                            @endcomponent
                            ...
                            <div class="mt-5 grid grid-cols-1 gap-5 xl:grid-cols-3">
                                <div class="mb-4">
                                    ...
                                    <input type="email" id="emailLojaInput" name="emailLojaInput" value="{{ $loja->email }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="telefoneLojaInput" name="telefoneLojaInput" value="{{ $loja->telefone }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                ...
                                <div class="card-body">
                                    <div class="mt-5 grid grid-cols-1 gap-5 xl:grid-cols-3">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="relative">
                                                <input type="password" id="senhaFarmaPopular" name="senhaFarmaPopular" value="{{ $loja->farmaciaPopular->senha ?? "" }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="flex items-center mt-2">
                                                ...
                                                <label for="producaoFarmaPopular" id="switchLabel3" class="inline-block text-base font-medium cursor-pointer">{{ $loja->farmaciaPopular && $loja->farmaciaPopular->producao ? 'Sim' : 'Não' }}</label>
                                            </div>
                        ...
                        <div class="hidden tab-pane" data-tab-id="2" id="representanteInfo">
                            <div class="mt-5 grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
                                <div class="mb-4 md:col-span-2">
                                    ...
                                    <input type="text" id="nomeRespInput" name="nomeRespInput" value="{{ $representanteLoja->nome }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" autofocus>
                                    @error('nomeRespInput')
                                        <div class="mt-1 text-sm text-red-500">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="cpfRespInput" name="cpfRespInput" value="{{ $representanteLoja->cpf }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                    @error('cpfRespInput')
                                        <div class="mt-1 text-sm text-red-500">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="rgRespInput" name="rgRespInput" value="{{ $representanteLoja->rg }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                    @error('rgRespInput')
                                        <div class="mt-1 text-sm text-red-500">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            {{-- Componente de Endereço --}}
                            @component('components.endereco', [
                                    'cep' => $representanteLoja->endereco->cep ?? null,
                                    'endereco' => $representanteLoja->endereco->logradouro ?? null,
                                    'bairro' => $representanteLoja->endereco->bairro ?? null,
                                    'cidade' => $representanteLoja->endereco->cidade->nome ?? null,
                                    'numero' => $representanteLoja->end_num ?? null,
                                    'complemento' => $representanteLoja->complemento ?? null,
                                    'sigla_estado' => $representanteLoja->endereco->cidade->estado->sigla ?? null,
                                    'prefix' => "resp"
                                ])
                            @endcomponent
                            ...
                            <div class="mt-5 grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
                                <div class="mb-4">
                                    ...
                                    <select name="estadoCivilRespInput" id="estadoCivilRespInput" class="form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                        <option value="Solteiro" {{ $representanteLoja->estado_civil === 'Solteiro' ? 'selected' : '' }}>Solteiro</option>
                                        <option value="Casado" {{ $representanteLoja->estado_civil === 'Casado' ? 'selected' : '' }}>Casado</option>
                                        <option value="Divorciado" {{ $representanteLoja->estado_civil === 'Divorciado' ? 'selected' : '' }}>Divorciado</option>
                                        <option value="Separado" {{ $representanteLoja->estado_civil === 'Separado' ? 'selected' : '' }}>Separado</option>
                                        <option value="Viuvo" {{ $representanteLoja->estado_civil === 'Viuvo' ? 'selected' : '' }}>Viúvo</option>
                                    </select>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="profissaoRespInput" name="profissaoRespInput" value="{{ $representanteLoja->profissao }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="date" id="dataNascRespInput" name="dataNascRespInput" value="{{ $representanteLoja->data_nasc }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
