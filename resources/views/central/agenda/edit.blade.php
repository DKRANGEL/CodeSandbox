...
@section('content')
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
            <div class="grow mt-5">
                <h5 class="text-2xl">Edição de Agenda</h5>
            </div>
        </div>
        ...
        <div class="card mt-5">
            <div class="card-body">
                <form action="{{ route(request()->getHost().'.agendas.atualizar', ['id' => $agenda->id]) }}" method="POST">
                    @csrf
                    <div class="mt-5 grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-3">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="apelidoAgendaInput" name="apelidoAgendaInput" value="{{ $agenda->apelido }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="empresaAgendaInput" name="empresaAgendaInput" value="{{ $agenda->empresa }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                    ...
                    @component('components.endereco', [
                            'cep' => $agenda->endereco->cep ?? null,
                            'endereco' => $agenda->endereco->logradouro ?? null,
                            'bairro' => $agenda->endereco->bairro ?? null,
                            'cidade' => $agenda->endereco->cidade->nome ?? null,
                            'numero' => $agenda->end_num ?? null,
                            'complemento' => $agenda->complemento ?? null,
                            'sigla_estado' => $agenda->endereco->cidade->estado->sigla ?? null,
                            'prefix' => null
                        ])
                    @endcomponent
                    ...
                    <div class="mt-5 grid grid-cols-1 gap-5 xl:grid-cols-4">
                        <div class="mb-4">
                            ...
                            <input type="text" id="emailAgendaInput" name="emailAgendaInput" value="{{ $agenda->email }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="celularAgendaInput" name="celularAgendaInput" value="{{ $agenda->celular }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" id="dataNascAgendaInput" name="dataNascAgendaInput" value="{{ $agenda->data_nasc }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
