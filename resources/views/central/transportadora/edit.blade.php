...
@section('content')
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        @component('components.titulo-pagina', ['nome' => "Edição de Transportadora"])
        @endcomponent
        ...
        <div class="card mt-5">
            <div class="card-body">
                <form action="{{ route(request()->getHost().'.transportadoras.atualizar', ['id' => $transportadora->id]) }}" method="POST">
                    @csrf
                    <div class="mt-5 grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <div class="mb-4 md:col-span-2">
                            ...
                            <input type="text" id="nomeTranspInput" name="nomeTranspInput" value="{{ $transportadora->nome }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="inscricaoEstadualInput" value="{{ $transportadora->inscricao_estadual }}" name="inscricaoEstadualInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                    ...
                    @component('components.endereco', [
                            'cep' => $transportadora->endereco->cep ?? null,
                            'endereco' => $transportadora->endereco->logradouro ?? null,
                            'bairro' => $transportadora->endereco->bairro ?? null,
                            'cidade' => $transportadora->endereco->cidade->nome ?? null,
                            'numero' => $transportadora->end_num ?? null,
                            'complemento' => $transportadora->complemento ?? null,
                            'sigla_estado' => $transportadora->endereco->cidade->estado->sigla ?? null,
                            'prefix' => null
                        ])
                    @endcomponent
                    ...
                    <div class="mt-5 grid grid-cols-1 gap-5 xl:grid-cols-4">
                        <div class="mb-4">
                            ...
                            <input type="email" id="emailTranspInput" name="emailTranspInput" value="{{ $transportadora->email }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="telefoneTranspInput" name="telefoneTranspInput" value="{{ $transportadora->telefone }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="celularTranspInput" name="celularTranspInput" value="{{ $transportadora->celular }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="contatoTranspInput" name="contatoTranspInput" value="{{ $transportadora->contato }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
